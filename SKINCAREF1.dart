...
class SKINCAREF1 extends StatefulWidget {
  const SKINCAREF1({super.key});

  @override
  State<SKINCAREF1> createState() => _SKINCAREF1State();
}

class _SKINCAREF1State extends State<SKINCAREF1> {
  @override
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Padding(
                ...
                child: Padding(
                  ...
                  child: Image.asset('assets/images/skin1.png'),
                ),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 10),
              child: Text('Himalaya Healthy Powder Pet Food, Meat & Rice, Adult Dog, 10 Kg',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text('- Healthy PET food - Adult is a complete and balanced food with over 20 nutrients, vitamins, and minerals, which provides a perfect balance of nutrition', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- It is fortified with herbs for additional health benefits for dogs', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Herbal Dog Foods for Adult Dogs', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Good for Liver, Kidney and general Health', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- No Side Effect on Digestive Organs', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Trusted Brand Himalaya', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
