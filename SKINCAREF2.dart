...
class SKINCAREF2 extends StatefulWidget {
  const SKINCAREF2({super.key});

  @override
  State<SKINCAREF2> createState() => _SKINCAREF2State();
}

class _SKINCAREF2State extends State<SKINCAREF2> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Farmina Pet Foods Quinoa Skin and Coat Dry Dog Food, Grain-Free, Adult Breed, 2.5-kg',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text('- Farmina N&D Quinoa Skin & Coat - Duck, Coconut and Turmeric is a complete food for adult dogs, suggested for nutrient intolerances and avert allergies. It’s a specific formula for food sensitivities, useful to restore and maintain skin and hair wellness.', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- 92% of protein from animal origin, 0% artificial preservatives, 0% grains.', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- The use of a single animal protein source that is Duck in Skin & Coat diet helps against food intolerance and allergies already known against other more common protein sources.', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- It is enriched with Fish Oil, Omega-3 fatty acid and vitamins that reduce inflammation at various organs and body parts, like skin and gastrointestinal tract.',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- The functional ingredients like Coconut is rich in Zinc which helps protect skin.', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
