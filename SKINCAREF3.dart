...
class SKINCAREF3 extends StatefulWidget {
  const SKINCAREF3({super.key});

  @override
  State<SKINCAREF3> createState() => _SKINCAREF3State();
}

class _SKINCAREF3State extends State<SKINCAREF3> {
  @override
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Padding(
                ...
                child: Padding(
                  ...
                  child: Image.asset('assets/images/skin3.png'),
                ),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 10),
              child: Text('Purina Pro Plan Puppy Dry Dog Food for Medium Breed,Chicken Flavor2.5kg',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text('- Purina PRO PLAN Puppy Food from the house of Nestlé has been developed with 120+ years of experience in pet nutrition', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Developed by 500+ nutritionists, vets & scientists', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Contains colostrum that enhances immune response', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Contains DHA that nourishes brain & vision development',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Made with real chicken. No added artificial colors, flavours or preservatives!', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
