...
class SKINCAREF4 extends StatefulWidget {
  const SKINCAREF4({super.key});

  @override
  State<SKINCAREF4> createState() => _SKINCAREF4State();
}

class _SKINCAREF4State extends State<SKINCAREF4> {
  @override
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Padding(
                ...
                child: Padding(
                  ...
                  child: Image.asset('assets/images/skin4.png'),
                ),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 10),
              child: Text('Purina Supercoat Adult Healthy Weight Dry Dog Food, Chicken, 3 Kg',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text('- PURINA SUPERCOAT Adult dog food from Nestlé', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Australiaâ€s #1 dry dog food brand now in India', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Tailored nutrition for your dogâ€s overall health to bring out his active best', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Calorie controlled diet to maintain your dogâ€s healthy weight',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Keeps his digestive system healthy with natural fibre', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Helps him feel full throughout the day with high plant fibre', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Natural - Contains no artificial colors and flavors', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
