...
class SKINCAREF6 extends StatefulWidget {
  const SKINCAREF6({super.key});

  @override
  State<SKINCAREF6> createState() => _SKINCAREF6State();
}

class _SKINCAREF6State extends State<SKINCAREF6> {
  @override
          ...
          children: [
            Container(
              ...
              child: Padding(
                ...
                child: Padding(
                  ...
                  child: Image.asset('assets/images/skin6.png'),
                ),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 10),
              child: Text('Himalaya Healthy Pet Food For Dog -Puppy,Large, Chicken, 3 kg',
                style: TextStyle(
            ...
            Row(
              children: [
                Padding(
                  padding: const EdgeInsets.only(left: 10),
                  child: Text('₹770', style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'Inter',
                    fontSize: 14,
            ...
            Padding(
              ...
              child: Text('- Complete and balanced food with over 20 nutrients, vitamins, and minerals, which provides a perfect balance of nutrition', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Maintaining healthy skin and shiny coat in puppies', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Supports digestion in puppie', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(right: 100),
              child: Text('- Supports immunity in puppies',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- breed_recommendation:all breed sizes | age_range_description:baby', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- target_audience_keywords:dogs | item_form:chunks', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
